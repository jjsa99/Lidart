 ...
 int main(int argc, char **argv)
{
  ...
  image_transport::Subscriber sub_right = it.subscribe("stereo/camera_right/image_raw_right", 1, imageCallback_right);
  // ROS_INFO("Subscribed right topic");
  image_transport::Subscriber sub_left  = it.subscribe("stereo/camera_left/image_raw_left", 1, imageCallback_left);
