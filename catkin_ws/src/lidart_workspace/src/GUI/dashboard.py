...
def reset():
    ...
    opstepv.delete(0,END)
    opsteph.delete(0,END)
    opFoVh.delete(0,END)
    opFoVv.delete(0,END)
    opOSH.delete(0,END)
    opOSV.delete(0,END)
